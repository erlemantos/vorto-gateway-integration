...
public interface INewConfiguration {
  ...
  void addConfigurationValue(String propertyName, PrimitiveType type, Object propertyValue);
  
  void addConfigurationValue(String propertyName, boolean isMultiple, PrimitiveType type, Object propertyValue);
